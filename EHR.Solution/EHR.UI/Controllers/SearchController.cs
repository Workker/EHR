...
namespace EHR.UI.Controllers
{
    ...
    public class SearchController : System.Web.Mvc.Controller
    {
        ...
        {
            var result = patients.OrderBy(p=>p.Name).Aggregate("{\"results\":[{\"type\":\"header\",\"text\":\"Pacientes\"}", (current, patient) => current + (",{\"type\":\"person\",\"cpf\":\"" + patient.Cpf + "\",\"name\":\"" + patient.Name + "\",\"hospital\":\"" + patient.Hospital.Name + "\", \"imageUrl\":\"/Images/Profiles/1.jpg\"}"));
            return result + "]}";
        }
