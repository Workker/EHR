...
namespace EHR.UI.Controllers
{
    public class SearchController : System.Web.Mvc.Controller
    {
        ...
        {
            var result = patients.Aggregate("{\"results\":[{\"type\":\"header\",\"text\":\"Pacientes\"}", (current, patient) => current + (",{\"type\":\"person\",\"id\":\"" + patient.Id + "\",\"name\":\"" + patient.Name + "\",\"hospital\":\"" + Enum.GetName(typeof(DbEnum), patient.Hospital) + "\", \"imageUrl\":\"../Images/Profiles/1.jpg\"}"));
